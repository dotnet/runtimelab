...
static MethodDesc * FindTightlyBoundWrappedMethodDesc_DEBUG(MethodDesc * pMD)
{
    ...
    bool isAsync2HelperMethod = pMD->IsAsync2HelperMethod();
        ...
        if (!it.IsVirtual()) {
            ...
            if (pCurMethod && !pCurMethod->IsUnboxingStub()) {
                if ((pCurMethod->GetMemberDef() == methodDef)  &&
                    ...
                    (pCurMethod->IsAsync2HelperMethod() == isAsync2HelperMethod))
                {
                    return pCurMethod;
                }
            }
                                                  ...
                                                  BOOL getWrappedCode)
{
...

    {
        ...
        pNewMD = FindLoadedInstantiatedMethodDesc(pExactMT,
                                                  ...
                                                  methodInst,
                                                  getWrappedCode,
                                                  pGenericMDescInRepMT->IsAsync2HelperMethod());
                                                     ...
                                                     MethodDesc *pCanonicalMD)
{
    ...
    InstantiatedMethodDesc *pInstMD = FindLoadedInstantiatedMethodDesc(pExactMT,
                                                                       ...
                                                                       Instantiation(),
                                                                       FALSE,
                                                                       pCanonicalMD->IsAsync2HelperMethod());
    ...
    else if (forceBoxedEntryPoint)
    {
        ...
        if (methodInst.IsEmpty())
        {
            ...
            pResultMD = pTable->FindMethodDesc(TypeHandle(pRepMT),
                                               ...
                                               Instantiation(),
                                               FALSE /* no inst param */,
                                               pMDescInCanonMT->IsAsync2HelperMethod());
        ...
        else
        {
            ...
            if (!pResultMD)
            {
                ...
                _ASSERTE(pNonUnboxingStub->IsAsync2HelperMethod() == pMDescInCanonMT->IsAsync2HelperMethod());
                ...
                pResultMD = pTable->FindMethodDesc(TypeHandle(pExactMT),
                                                   ...
                                                   methodInst,
                                                   FALSE /* no inst param */,
                                                   pNonUnboxingStub->IsAsync2HelperMethod());
