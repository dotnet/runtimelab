...
enum CorInfoHelpFunc
{
    ...
    CORINFO_HELP_COMPUTE_GREEN_THREAD_TRANSITION, // Adjust function pointer for green thread transition
    CORINFO_HELP_GREEN_THREAD_MORE_STACK,    // Helper for when a green thread needs more stack space
