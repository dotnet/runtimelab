...
// It will be set in InitJITHelpers2
    ...
    JITHELPER(CORINFO_HELP_COMPUTE_GREEN_THREAD_TRANSITION, JIT_GreenThreadTransition, CORINFO_HELP_SIG_REG_ONLY)
    JITHELPER(CORINFO_HELP_GREEN_THREAD_MORE_STACK, JIT_GreenThreadMoreStack, CORINFO_HELP_SIG_REG_ONLY)
