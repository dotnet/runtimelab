...
namespace ILCompiler
{
    public sealed class LLVMCodegenCompilationBuilder : RyuJitCompilationBuilder
    {
        ...
        protected override RyuJitCompilation CreateCompilation(RyuJitCompilationOptions options, CorJitFlag[] jitFlags,  KeyValuePair<string, string>[] ryujitOptions, string jitPath)
        {
            ...
            return new LLVMCodegenCompilation(graph, factory, _compilationRoots, GetILProvider(), _debugInformationProvider, _logger, _config, _inliningPolicy, _instructionSetSupport, _methodImportationErrorProvider, _readOnlyFieldPolicy, _methodLayoutAlgorithm, _fileLayoutAlgorithm, options, _parallelism, _orderFile);
        }
    }
