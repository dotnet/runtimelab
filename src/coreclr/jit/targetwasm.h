...
// clang-format off
  ...
  #define REG_CALLEE_SAVED_ORDER   REG_NA
  #define RBM_CALLEE_SAVED_ORDER   RBM_NONE
  ...
  #define STR_FPBASE               "n/a"
  #define REG_SPBASE               REG_NA
  #define RBM_SPBASE               REG_NA
  #define STR_SPBASE               "n/a"
  
  #define FIRST_ARG_STACK_OFFS     0
  
  #define MAX_REG_ARG              0 // In our LLVM "ABI" all arguments go on the stack
