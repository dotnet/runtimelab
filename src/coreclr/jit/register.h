...
#undef REG_LLVM
#define REG_LLVM JITREG_LLVM
#undef REG_STK_CANDIDATE_UNCONDITIONAL
#define REG_STK_CANDIDATE_UNCONDITIONAL JITREG_STK_CANDIDATE_UNCONDITIONAL
#undef REG_STK_CANDIDATE_TENTATIVE
#define REG_STK_CANDIDATE_TENTATIVE JITREG_STK_CANDIDATE_TENTATIVE
#undef REG_STK_CANDIDATE_COMMITED
#define REG_STK_CANDIDATE_COMMITED JITREG_STK_CANDIDATE_COMMITED
#undef REG_STK
#define REG_STK JITREG_STK
