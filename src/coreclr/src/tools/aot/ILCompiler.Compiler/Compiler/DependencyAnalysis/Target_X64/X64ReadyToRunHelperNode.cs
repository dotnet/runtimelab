                ...
                case ReadyToRunHelperId.GetNonGCStaticBase:
                    {
                        ...
                        else
                        {
                            ...
                            encoder.EmitLEAQ(encoder.TargetRegister.Arg0, factory.TypeNonGCStaticsSymbol(target), -NonGCStaticsNode.GetClassConstructorContextSize(factory.Target, target));
                ...
                case ReadyToRunHelperId.GetThreadStaticBase:
                    {
                        ...
                        {
                            encoder.EmitLEAQ(encoder.TargetRegister.Arg2, factory.TypeNonGCStaticsSymbol(target), - NonGCStaticsNode.GetClassConstructorContextSize(factory.Target, target));
