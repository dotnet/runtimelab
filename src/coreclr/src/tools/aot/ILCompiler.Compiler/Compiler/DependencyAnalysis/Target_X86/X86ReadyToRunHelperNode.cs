                ...
                case ReadyToRunHelperId.GetNonGCStaticBase:
                    {
                        ...
                        else
                        {
                            ...
                            encoder.EmitMOV(encoder.TargetRegister.Arg0, factory.TypeNonGCStaticsSymbol(target), -NonGCStaticsNode.GetClassConstructorContextSize(factory.Target, target));
