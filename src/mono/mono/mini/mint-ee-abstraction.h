...
#else
#define MINT_EE_ITF(sym) mint_itf()->sym
#define MINT_EE_TITF(type,sym) mint_itf()->get_ ##type () -> sym
#define MINT_EE_TI_ITF(type,self,sym) mint_itf()->get_ ## type ## _inst (self) -> sym
#endif
