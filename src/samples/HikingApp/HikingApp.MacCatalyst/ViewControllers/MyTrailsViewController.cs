...
internal class MyTrailsViewController : UIViewController
{
    ...
    {
        PurchasedTrails = new ObservableCollection<ViewControllers.TrailViewController>(Models.Trail.GetTestTrailData(2).Select(trail => new ViewControllers.TrailViewController(trail)));
     ...
     public override void ViewDidLoad ()
    {
        ...
        foreach (var trailViewController in PurchasedTrails)
        {
            ...
            NSLayoutConstraint.ActivateConstraints(new[]
            {
                ...
                detailsButton.BottomAnchor.ConstraintEqualTo(trailView.BottomAnchor),
