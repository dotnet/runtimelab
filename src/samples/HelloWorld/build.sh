...
xcrun tapi stubify --filetype=tbd-v4  libHelloLibrary.dylib -o libHelloLibrary.tbd
...
if [ $? -eq 0 ]; then
    ...
    dotnet ../../../artifacts/bin/Swift.Bindings/Debug/net9.0/Swift.Bindings.dll -a "./HelloLibrary.abi.json" -d "./libHelloLibrary.dylib" -t "./libHelloLibrary.tbd" -o "./"
    dotnet run
else
