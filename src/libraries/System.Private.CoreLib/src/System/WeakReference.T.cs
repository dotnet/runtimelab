        ...
        private T? Target
        {
            ...
            get
            {
                ...
                if ((th & ComAwareBit) != 0)
                {
                    ...
                    unsafe { target = Unsafe.As<T>(cwr.Target) ?? cwr.RehydrateTarget<T>(); }
                ...
                unsafe { target = Unsafe.As<T>(GCHandle.InternalGetBridgeWait(th)); }
#else
                unsafe { target = Unsafe.As<T>(GCHandle.InternalGet(th)); }
#endif
