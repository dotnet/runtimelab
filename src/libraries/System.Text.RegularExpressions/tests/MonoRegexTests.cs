...
namespace System.Text.RegularExpressions.Tests
{
    public class MonoTests
    {
        ...
        public static IEnumerable<object[]> RegexTestCases()
        {
            ...
            yield return new object[] { @"((((((((((a))))))))))\10", RegexOptions.None, "aa", "Pass. Group[0]=(0,2) Group[1]=(0,1) Group[2]=(0,1) Group[3]=(0,1) Group[4]=(0,1) Group[5]=(0,1) Group[6]=(0,1) Group[7]=(0,1) Group[8]=(0,1) Group[9]=(0,1) Group[10]=(0,1)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(abc)\1", RegexOptions.None, "abcabc", "Pass. Group[0]=(0,6) Group[1]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"([a-c]*)\1", RegexOptions.None, "abcabc", "Pass. Group[0]=(0,6) Group[1]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"\1", RegexOptions.None, "-", "Error." };
            yield return new object[] { @"\2", RegexOptions.None, "-", "Error." };
            yield return new object[] { @"(a)|\1", RegexOptions.None, "a", "Pass. Group[0]=(0,1) Group[1]=(0,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(a)|\1", RegexOptions.None, "x", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(a)|\2", RegexOptions.None, "-", "Error." };
            yield return new object[] { @"(([a-c])b*?\2)*", RegexOptions.None, "ababbbcbc", "Pass. Group[0]=(0,5) Group[1]=(0,3)(3,2) Group[2]=(0,1)(3,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(([a-c])b*?\2){3}", RegexOptions.None, "ababbbcbc", "Pass. Group[0]=(0,9) Group[1]=(0,3)(3,3)(6,3) Group[2]=(0,1)(3,1)(6,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"((\3|b)\2(a)x)+", RegexOptions.None, "aaxabxbaxbbx", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"((\3|b)\2(a)x)+", RegexOptions.None, "aaaxabaxbaaxbbax", "Pass. Group[0]=(12,4) Group[1]=(12,4) Group[2]=(12,1) Group[3]=(14,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"((\3|b)\2(a)){2,}", RegexOptions.None, "bbaababbabaaaaabbaaaabba", "Pass. Group[0]=(15,9) Group[1]=(15,3)(18,3)(21,3) Group[2]=(15,1)(18,1)(21,1) Group[3]=(17,1)(20,1)(23,1)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"((((((((((a))))))))))\10", RegexOptions.IgnoreCase, "AA", "Pass. Group[0]=(0,2) Group[1]=(0,1) Group[2]=(0,1) Group[3]=(0,1) Group[4]=(0,1) Group[5]=(0,1) Group[6]=(0,1) Group[7]=(0,1) Group[8]=(0,1) Group[9]=(0,1) Group[10]=(0,1)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(abc)\1", RegexOptions.IgnoreCase, "ABCABC", "Pass. Group[0]=(0,6) Group[1]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"([a-c]*)\1", RegexOptions.IgnoreCase, "ABCABC", "Pass. Group[0]=(0,6) Group[1]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"a(?!b).", RegexOptions.None, "abad", "Pass. Group[0]=(2,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"a(?=d).", RegexOptions.None, "abad", "Pass. Group[0]=(2,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"a(?=c|d).", RegexOptions.None, "abad", "Pass. Group[0]=(2,2)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"^(a\1?){4}$", RegexOptions.None, "aaaaaaaaaa", "Pass. Group[0]=(0,10) Group[1]=(0,1)(1,2)(3,3)(6,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(a\1?){4}$", RegexOptions.None, "aaaaaaaaa", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(a\1?){4}$", RegexOptions.None, "aaaaaaaaaaa", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(a(?(1)\1)){4}$", RegexOptions.None, "aaaaaaaaaa", "Pass. Group[0]=(0,10) Group[1]=(0,1)(1,2)(3,3)(6,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(a(?(1)\1)){4}$", RegexOptions.None, "aaaaaaaaa", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(a(?(1)\1)){4}$", RegexOptions.None, "aaaaaaaaaaa", "Fail.", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(?<=a)b", RegexOptions.None, "ab", "Pass. Group[0]=(1,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a)b", RegexOptions.None, "cb", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a)b", RegexOptions.None, "b", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<!c)b", RegexOptions.None, "ab", "Pass. Group[0]=(1,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<!c)b", RegexOptions.None, "cb", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<!c)b", RegexOptions.None, "b", "Pass. Group[0]=(0,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<%)b", RegexOptions.None, "-", "Error." };
            ...
            yield return new object[] { @"^(?:b|a(?=(.)))*\1", RegexOptions.None, "abc", "Pass. Group[0]=(0,2) Group[1]=(1,1)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(ab)\d\1", RegexOptions.IgnoreCase, "Ab4ab", "Pass. Group[0]=(0,5) Group[1]=(0,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(ab)\d\1", RegexOptions.IgnoreCase, "ab4Ab", "Pass. Group[0]=(0,5) Group[1]=(0,2)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(?<![cd])b", RegexOptions.None, "dbcb", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<![cd])[ab]", RegexOptions.None, "dbaacb", "Pass. Group[0]=(2,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<!(c|d))b", RegexOptions.None, "dbcb", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<!(c|d))[ab]", RegexOptions.None, "dbaacb", "Pass. Group[0]=(2,1) Group[1]=", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<!cd)[ab]", RegexOptions.None, "cdaccb", "Pass. Group[0]=(5,1)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"((?s).)c(?!.)", RegexOptions.None, "a\nb\nc\n", "Pass. Group[0]=(3,2) Group[1]=(3,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"((?s)b.)c(?!.)", RegexOptions.None, "a\nb\nc\n", "Pass. Group[0]=(2,3) Group[1]=(2,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^b", RegexOptions.None, "a\nb\nc\n", "Fail." };
            yield return new object[] { @"()^b", RegexOptions.None, "a\nb\nc\n", "Fail." };
            yield return new object[] { @"((?m)^b)", RegexOptions.None, "a\nb\nc\n", "Pass. Group[0]=(2,1) Group[1]=(2,1)" };
            yield return new object[] { @"(x)?(?(1)a|b)", RegexOptions.None, "a", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(x)?(?(1)b|a)", RegexOptions.None, "a", "Pass. Group[0]=(0,1) Group[1]=", "DFAINCOMPATIBLE" };
            yield return new object[] { @"()?(?(1)b|a)", RegexOptions.None, "a", "Pass. Group[0]=(0,1) Group[1]=", "DFAINCOMPATIBLE" };
            yield return new object[] { @"()(?(1)b|a)", RegexOptions.None, "a", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"()?(?(1)a|b)", RegexOptions.None, "a", "Pass. Group[0]=(0,1) Group[1]=(0,0)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(\()?blah(?(1)(\)))$", RegexOptions.None, "(blah)", "Pass. Group[0]=(0,6) Group[1]=(0,1) Group[2]=(5,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(\()?blah(?(1)(\)))$", RegexOptions.None, "blah", "Pass. Group[0]=(0,4) Group[1]= Group[2]=", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(\()?blah(?(1)(\)))$", RegexOptions.None, "blah)", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(\()?blah(?(1)(\)))$", RegexOptions.None, "(blah", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(\(+)?blah(?(1)(\)))$", RegexOptions.None, "(blah)", "Pass. Group[0]=(0,6) Group[1]=(0,1) Group[2]=(5,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(\(+)?blah(?(1)(\)))$", RegexOptions.None, "blah", "Pass. Group[0]=(0,4) Group[1]= Group[2]=", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(\(+)?blah(?(1)(\)))$", RegexOptions.None, "blah)", "Fail.", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(?(?!a)a|b)", RegexOptions.None, "a", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?(?!a)b|a)", RegexOptions.None, "a", "Pass. Group[0]=(0,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?(?=a)b|a)", RegexOptions.None, "a", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?(?=a)a|b)", RegexOptions.None, "a", "Pass. Group[0]=(0,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?=(a+?))(\1ab)", RegexOptions.None, "aaab", "Pass. Group[0]=(1,3) Group[1]=(1,1) Group[2]=(1,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(?=(a+?))\1ab", RegexOptions.None, "aaab", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(\w+:)+", RegexOptions.None, "one:", "Pass. Group[0]=(0,4) Group[1]=(0,4)" };
            yield return new object[] { @"$(?<=^(a))", RegexOptions.None, "a", "Pass. Group[0]=(1,0) Group[1]=(0,1)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(?>a+)b", RegexOptions.None, "aaab", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"((?>a+)b)", RegexOptions.None, "aaab", "Pass. Group[0]=(0,4) Group[1]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?>(a+))b", RegexOptions.None, "aaab", "Pass. Group[0]=(0,4) Group[1]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"((?>[^()]+)|\([^()]*\))+", RegexOptions.None, "((abc(ade)ufh()()x", "Pass. Group[0]=(2,16) Group[1]=(2,3)(5,5)(10,3)(13,2)(15,2)(17,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=x+)", RegexOptions.None, "xxxxy", "Pass. Group[0]=(1,0)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"round\(((?>[^()]+))\)", RegexOptions.None, "_I(round(xs * sz),1)", "Pass. Group[0]=(3,14) Group[1]=(9,7)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"\GX.*X", RegexOptions.None, "aaaXbX", "Fail.", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(\w)?(abc)\1b", RegexOptions.None, "abcab", "Fail.", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"^(a)?(?(1)a|b)+$", RegexOptions.None, "a", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(a\1?)(a\1?)(a\2?)(a\3?)$", RegexOptions.None, "aaaaaa", "Pass. Group[0]=(0,6) Group[1]=(0,1) Group[2]=(1,2) Group[3]=(3,1) Group[4]=(4,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(a\1?){4}$", RegexOptions.None, "aaaaaa", "Pass. Group[0]=(0,6) Group[1]=(0,1)(1,2)(3,1)(4,2)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"\((?>[^()]+|\((?<depth>)|\)(?<-depth>))*(?(depth)(?!))\)", RegexOptions.None, "((a(b))c)", "Pass. Group[0]=(0,9) Group[1]=", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^\((?>[^()]+|\((?<depth>)|\)(?<-depth>))*(?(depth)(?!))\)$", RegexOptions.None, "((a(b))c)", "Pass. Group[0]=(0,9) Group[1]=", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^\((?>[^()]+|\((?<depth>)|\)(?<-depth>))*(?(depth)(?!))\)$", RegexOptions.None, "((a(b))c", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^\((?>[^()]+|\((?<depth>)|\)(?<-depth>))*(?(depth)(?!))\)$", RegexOptions.None, "())", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(((?<foo>\()[^()]*)+((?<bar-foo>\))[^()]*)+)+(?(foo)(?!))", RegexOptions.None, "((a(b))c)", "Pass. Group[0]=(0,9) Group[1]=(0,9) Group[2]=(0,1)(1,2)(3,2) Group[3]=(5,1)(6,2)(8,1) Group[4]= Group[5]=(4,1)(2,4)(1,7)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(((?<foo>\()[^()]*)+((?<bar-foo>\))[^()]*)+)+(?(foo)(?!))$", RegexOptions.None, "((a(b))c)", "Pass. Group[0]=(0,9) Group[1]=(0,9) Group[2]=(0,1)(1,2)(3,2) Group[3]=(5,1)(6,2)(8,1) Group[4]= Group[5]=(4,1)(2,4)(1,7)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(((?<foo>\()[^()]*)+((?<bar-foo>\))[^()]*)+)+(?(foo)(?!))", RegexOptions.None, "x(a((b)))b)x", "Pass. Group[0]=(1,9) Group[1]=(1,9) Group[2]=(1,2)(3,1)(4,2) Group[3]=(6,1)(7,1)(8,2) Group[4]= Group[5]=(5,1)(4,3)(2,6)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(((?<foo>\()[^()]*)+((?<bar-foo>\))[^()]*)+)+(?(foo)(?!))", RegexOptions.None, "x((a((b)))x", "Pass. Group[0]=(2,9) Group[1]=(2,9) Group[2]=(2,2)(4,1)(5,2) Group[3]=(7,1)(8,1)(9,2) Group[4]= Group[5]=(6,1)(5,3)(3,6)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(((?<foo>\()[^()]*)+((?<bar-foo>\))[^()]*)+)+(?(foo)(?!))$", RegexOptions.None, "((a(b))c","Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(((?<foo>\()[^()]*)+((?<bar-foo>\))[^()]*)+)+(?(foo)(?!))$", RegexOptions.None, "((a(b))c))","Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(((?<foo>\()[^()]*)+((?<bar-foo>\))[^()]*)+)+(?(foo)(?!))$", RegexOptions.None, ")(","Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"^(((?<foo>\()[^()]*)+((?<bar-foo>\))[^()]*)+)+(?(foo)(?!))$", RegexOptions.None, "((a((b))c)","Fail.", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(F)(2)(3)(4)(5)(6)(7)(8)(9)(10)(L)\11", RegexOptions.None, "F2345678910LL", "Pass. Group[0]=(0,13) Group[1]=(0,1) Group[2]=(1,1) Group[3]=(2,1) Group[4]=(3,1) Group[5]=(4,1) Group[6]=(5,1) Group[7]=(6,1) Group[8]=(7,1) Group[9]=(8,1) Group[10]=(9,2) Group[11]=(11,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(4)(5)(6)(7)(8)(9)(10)(L)\11", RegexOptions.ExplicitCapture, "F2345678910LL", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(4)(5)(6)(?<S>7)(8)(9)(10)(L)\1", RegexOptions.None, "F2345678910L71", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(4)(5)(6)(7)(8)(9)(10)(L)\11", RegexOptions.None, "F2345678910LF1", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(4)(5)(6)(?<S>7)(8)(9)(10)(L)\11", RegexOptions.None, "F2345678910L71", "Pass. Group[0]=(0,13) Group[1]=(0,1) Group[2]=(1,1) Group[3]=(2,1) Group[4]=(3,1) Group[5]=(4,1) Group[6]=(5,1) Group[7]=(7,1) Group[8]=(8,1) Group[9]=(9,2) Group[10]=(11,1) Group[11]=(6,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(?<S>4)(5)(6)(?'S'7)(8)(9)(10)(L)\10", RegexOptions.None, "F2345678910L71", "Pass. Group[0]=(0,13) Group[1]=(0,1) Group[2]=(1,1) Group[3]=(2,1) Group[4]=(4,1) Group[5]=(5,1) Group[6]=(7,1) Group[7]=(8,1) Group[8]=(9,2) Group[9]=(11,1) Group[10]=(3,1)(6,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(?<S>4)(5)(6)(?'S'7)(8)(9)(10)(L)\10", RegexOptions.ExplicitCapture, "F2345678910L70", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(?<S>4)(5)(6)(?'S'7)(8)(9)(10)(L)\1", RegexOptions.ExplicitCapture, "F2345678910L70", "Pass. Group[0]=(0,13) Group[1]=(3,1)(6,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?n:(F)(2)(3)(?<S>4)(5)(6)(?'S'7)(8)(9)(10)(L)\1)", RegexOptions.None, "F2345678910L70", "Pass. Group[0]=(0,13) Group[1]=(3,1)(6,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(?<S>4)(5)(6)(?'S'7)(8)(9)(10)(L)(?(10)\10)", RegexOptions.None, "F2345678910L70","Pass. Group[0]=(0,13) Group[1]=(0,1) Group[2]=(1,1) Group[3]=(2,1) Group[4]=(4,1) Group[5]=(5,1) Group[6]=(7,1) Group[7]=(8,1) Group[8]=(9,2) Group[9]=(11,1) Group[10]=(3,1)(6,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(?<S>4)(5)(6)(?'S'7)(8)(9)(10)(L)(?(S)|\10)", RegexOptions.None, "F2345678910L70","Pass. Group[0]=(0,12) Group[1]=(0,1) Group[2]=(1,1) Group[3]=(2,1) Group[4]=(4,1) Group[5]=(5,1) Group[6]=(7,1) Group[7]=(8,1) Group[8]=(9,2) Group[9]=(11,1) Group[10]=(3,1)(6,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(?<S>4)(5)(6)(?'S'7)(8)(9)(10)(L)(?(7)|\10)", RegexOptions.None, "F2345678910L70","Pass. Group[0]=(0,12) Group[1]=(0,1) Group[2]=(1,1) Group[3]=(2,1) Group[4]=(4,1) Group[5]=(5,1) Group[6]=(7,1) Group[7]=(8,1) Group[8]=(9,2) Group[9]=(11,1) Group[10]=(3,1)(6,1)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(F)(2)(3)(?<S>4)(5)(6)(?'S'7)(8)(9)(10)(L)(?(K)|\10)", RegexOptions.None, "F2345678910L70","Pass. Group[0]=(0,13) Group[1]=(0,1) Group[2]=(1,1) Group[3]=(2,1) Group[4]=(4,1) Group[5]=(5,1) Group[6]=(7,1) Group[7]=(8,1) Group[8]=(9,2) Group[9]=(11,1) Group[10]=(3,1)(6,1)", "DFAINCOMPATIBLE" };
            ...
            yield return new object[] { @"(?<=a+)(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(1,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a*)(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a{1,5})(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(1,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a{1})(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(1,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a{1,})(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(1,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a+?)(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(1,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a*?)(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a{1,5}?)(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(1,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<=a{1}?)(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(1,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<!a+)(?:a)*bc", RegexOptions.None, "aabc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<!a*)(?:a)*bc", RegexOptions.None, "aabc", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c*)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c+)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c{1})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c{1,5})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c{1,})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c*?)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c+?)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c{1}?)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c{1,5}?)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?=c{1,}?)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,3)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*?(?=c*)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*?(?=c+)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*?(?=c{1})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*?(?=c{1,5})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*?(?=c{1,})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,2)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?!c*)", RegexOptions.None, "abcc", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?!c+)", RegexOptions.None, "abcc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?!c{1})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?!c{1,5})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"abc*(?!c{1,})", RegexOptions.None, "abcc", "Pass. Group[0]=(0,4)", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(a)(?<1>b)(?'1'c)", RegexOptions.ExplicitCapture, "abc", "Pass. Group[0]=(0,3) Group[1]=(1,1)(2,1)" };
            yield return new object[] { @"(?>a*).", RegexOptions.ExplicitCapture, "aaaa", "Fail.", "DFAINCOMPATIBLE" };
            yield return new object[] { @"(?<ab>ab)c\1", RegexOptions.None, "abcabc", "Pass. Group[0]=(0,5) Group[1]=(0,2)", "DFAINCOMPATIBLE" };
