                ...
                {
                    {
                        if (s_boolean == null)
                        {
                            s_boolean = new JsonValueInfo<bool>(new BooleanConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_byteArray == null)
                        {
                            s_byteArray = new JsonValueInfo<byte[]>(new ByteArrayConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_byte == null)
                        {
                            s_byte = new JsonValueInfo<byte>(new ByteConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_char == null)
                        {
                            s_char = new JsonValueInfo<char>(new CharConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_dateTime == null)
                        {
                            s_dateTime = new JsonValueInfo<DateTime>(new DateTimeConverter(), GetOptions());
                        }
                ...
                {
                    {
                        ...
                        {
                            s_dateTimeOffset = new JsonValueInfo<DateTimeOffset>(new DateTimeOffsetConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_decimal == null)
                        {
                            s_decimal = new JsonValueInfo<decimal>(new DecimalConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_double == null)
                        {
                            s_double = new JsonValueInfo<double>(new DoubleConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_guid == null)
                        {
                            s_guid = new JsonValueInfo<Guid>(new GuidConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_int16 == null)
                        {
                            s_int16 = new JsonValueInfo<short>(new Int16Converter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_int32 == null)
                        {
                            s_int32 = new JsonValueInfo<int>(new Int32Converter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_int64 == null)
                        {
                            s_int64 = new JsonValueInfo<long>(new Int64Converter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_single == null)
                        {
                            s_single = new JsonValueInfo<float>(new SingleConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_sbyte == null)
                        {
                            s_sbyte = new JsonValueInfo<sbyte>(new SByteConverter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_string == null)
                        {
                            var valueInfo = new JsonValueInfo<string>(new StringConverter(), GetOptions());
                            valueInfo.CompleteInitialization(canBeDynamic: false);
                            s_string = valueInfo;
                        }
                ...
                {
                    {
                        if (s_uint16 == null)
                        {
                            s_uint16 = new JsonValueInfo<ushort>(new UInt16Converter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_uint32 == null)
                        {
                            s_uint32 = new JsonValueInfo<uint>(new UInt32Converter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_uint64 == null)
                        {
                            s_uint64 = new JsonValueInfo<ulong>(new UInt64Converter(), GetOptions());
                        }
                ...
                {
                    {
                        if (s_uri == null)
                        {
                            s_uri = new JsonValueInfo<Uri>(new UriConverter(), GetOptions());
                        }
