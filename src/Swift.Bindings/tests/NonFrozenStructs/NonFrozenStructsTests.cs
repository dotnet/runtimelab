...
namespace BindingsGeneration.Tests
{
    public class NonFrozenStructsTests : IClassFixture<NonFrozenStructsTests.TestFixture>
    {
        ...
        public class TestFixture
        {
            ...
            {
                BindingsGenerator.GenerateBindings("NonFrozenStructs/NonFrozenStructsTests.abi.json", "NonFrozenStructs/");
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct0", new object[] { });
        ...
        public static void TestSwiftStruct1()
        {
            ...
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct1", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct2", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct3", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct4", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct5", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct6", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct7", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct8", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct9", new object[] { });
        ...
        {
            long[] result = (long[])TestsHelper.Execute(_assemblyPath, "Test.MainClass", "SwiftNonFrozenStruct10", new object[] { });
