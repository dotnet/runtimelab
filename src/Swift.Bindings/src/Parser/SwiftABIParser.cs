...
namespace BindingsGeneration
{
    ...
    public sealed unsafe class SwiftABIParser : ISwiftParser
    {
        ...
        private static SwiftTypeName GetSwiftTypeName(BaseDecl parentDecl, string name)
            => parentDecl switch
            {
                ModuleDecl moduleDecl => SwiftTypeName.ModuleLevelType(moduleDecl.Name, ExtractUniqueName(name)),
                TypeDecl typeDecl => SwiftTypeName.NestedType(typeDecl.SwiftTypeName, ExtractUniqueName(name)),
