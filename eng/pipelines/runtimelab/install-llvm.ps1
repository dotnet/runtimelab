...
{
    & "$env:CMakePath" -G "Visual Studio 17 2022" -DCMAKE_BUILD_TYPE=Release -DLLVM_USE_CRT_RELEASE=MT -Thost=x64 ..
}
else
{
    & "$env:CMakePath" -G "Visual Studio 17 2022" -DCMAKE_BUILD_TYPE=Debug -DLLVM_USE_CRT_DEBUG=MTd -Thost=x64 ..
}
