# .NET Runtime - Vectorized Dictionary

This branch contains an experimental version of the .NET runtime where the System.Collections.Generic.Dictionary type is vectorized using Vector128 and platform-specific intrinsics.
